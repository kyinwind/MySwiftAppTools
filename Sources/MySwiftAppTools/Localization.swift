...
public enum MySwiftAppToolsL10n {
    ...
    public static let toastHistoryTitle = "Toast.History.title"
    public static let toastHistoryCount = "Toast.History.count"
    public static let toastHistoryMore = "Toast.History.more"
    public static let toastHistoryAllLoaded = "Toast.History.allLoaded"
    public static let toastHistoryClearAll = "Toast.History.clearAll"
    public static let toastHistoryClearConfirmTitle = "Toast.History.clearConfirmTitle"
    public static let toastHistoryClearConfirmMsg = "Toast.History.clearConfirmMsg"
    public static let toastHistoryDelete = "Toast.History.delete"
    ...
    public static let toastHistoryMinutesAgo = "Toast.History.minutesAgo"
    public static let toastHistoryCancel = "Toast.History.cancel"
    public static let toastHistoryClose = "Toast.History.close"
}
